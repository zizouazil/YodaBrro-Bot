...
client.on("message", message => {
  if (message.author.bot) return;
 if(!message.channel.guild)return;
  if (!client[message.author.id]) client[message.author.id] = {
    tite: 'HypeLC User',
    rep: 0,
   reps: 'NOT YET',
...
if (message.content.startsWith(prefix + 'credits')) {
  if(men) {
  if (!client[men.id]) client[men.id] = {
   lastDaily:'Not Collected',
   credits: 1,
 };
  }
...
if(message.content.startsWith(prefix + "daily")) {
  ...
  if(client[message.author.id].lastDaily != moment().format('day')) {
   client[message.author.id].lastDaily = moment().format('day')
   client[message.author.id].credits += 310
...
if(message.content.startsWith(prefix + 'trans')) {
        ...
        if (isNaN(args[0])) {
            ...
            return; // Remember to return if you are sending an error message! So the rest of the code doesn't run.
             ...
             if(client[message.author.id].credits < args[0]) return message.channel.send("**Your Credits is not enough  that**")
if(args[0].startsWith("-")) return  message.channel.send('**!! I Cant Do it**');
            ...
            var mentionned = message.mentions.users.first();
if (!client[sender.id]) client[sender.id] = {}
if (!client[sender.id].credits) client[sender.id].credits = 310;
fs.writeFile('./profile.json', JSON.stringify(client), (err) => {
if (err) console.error(err);
})
var x = ['5587' ,' 9978' , '3785' , '7734' , '9864' , '7681' , '3758' , '7834' , '3489' , '1382' , '7389' , '8762' , '0889' , '0388' , '3316' , '0976' , '8603' , '1842' , '4565' , '9524' , '9524' , '0964' , '5930' , '5678' , '9567' , '6099' , '7058' , '0001' , '1324' , '9834' , '7668' , '0378' , '7055' , '9733' , '9876' , '9846' , '9685' , '8574' , '8975' , '9845' , '9862' , '0069' , '0807' , '0673' , '0813' , '1235' , '6879'];
var x2 = ['5587' ,' 9978' , '3785' , '7734' , '9864' , '7681' , '3758' , '7834' , '3489' , '1382' , '7389' , '8762' , '0889' , '0388' , '3316' , '0976' , '8603' , '1842' , '4565' , '9524' , '9524' , '0964' , '5930' , '5678' , '9567' , '6099' , '7058' , '0001' , '1324' , '9834' , '7668' , '0378' , '7055' , '9733' , '9876' , '9846' , '9685' , '8574' , '8975' , '9845' , '9862' , '0069' , '0807' , '0673' , '0813' , '1235' , '6879'];
        var x3 = Math.floor(Math.random()*x.length)
        message.channel.send(` \`${args}\`** : Amount**  \n \`${x[x3]}\` ** : Write the number to complete the transfer **`).then(msg1=> { 
      ...
      if  (!client[defineduser.id]) client[defineduser.id] = {}
      if (!client[defineduser.id].credits) client[defineduser.id].credits = 200;
      client[defineduser.id].credits += (+args[0]);
      client[sender.id].credits += (-args[0]);
